...
export default function FoundationSection() {
  return (
    <section
      id="foundation"
      className="bg-white px-5 py-20 sm:px-8 sm:py-24 lg:px-12 lg:py-24"
    >
      <div className="mx-auto max-w-360">
        <h2 className="text-[34px] font-bold leading-[1.1] tracking-[-1.5px] text-[#050505] sm:text-[40px] lg:text-[42px]">
          Build Your Foundation
        </h2>

        <p className="mt-5 max-w-190 text-[16px] leading-7 text-[#737680] sm:text-[18px]">
          Establish a robust digital presence that commands authority
