  ...
  return (
    <section className="relative overflow-hidden bg-[#0B1220] px-5 py-24 text-white sm:px-8 lg:px-10 lg:py-28">
      ...
      <div className="relative z-10 mx-auto flex max-w-[1100px] flex-col items-center text-center">
        ...
        <h1 className="mt-8 max-w-[900px] text-[56px] font-extrabold leading-[0.92] tracking-[-2px] text-[#FFFFFF] sm:text-[72px] lg:text-[88px]">
          Helping Businesses
          <br />
          Grow{" "}
        ...
        <p className="mt-10 max-w-[600px] text-[16px] font-medium leading-7 text-white/65 sm:text-[18px]">
